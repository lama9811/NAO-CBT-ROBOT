...
_BASE = (
    ...
    "    distortion, and do NOT call `suggest_reframe`. A thought can be sad, "
    "    worried, or negative about something genuinely bad and still not be "
    "    distorted. Move to the next step, or close the record if there is "
    "    nothing to work on.\n"
